   ...
   return (
      <div className='flex flex-col rounded-[15px] shadow-card dark:shadow-none bg-white dark:bg-secondary-dark-main'>
         ...
         <div className='flex flex-col flex-1 px-5 py-[15px]'>
            <div className='flex items-center gap-x-[10px] text-letter-3 mb-[15px]'>
               <IconFolder width='18' height='18' />
               <span className='font-medium text-xs leading-6'>
                  Real Estate
               </span>
            </div>
            <Heading>New iMac For My Business!</Heading>
            <Description className='text-xs mt-[5px]'>
               My computer decided to die. As a result, my small business.
            </Description>
            <div className='flex items-center justify-between mt-[15px]'>
               <div className='flex flex-col gap-y-[2px]'>
                  <span className='font-semibold text-sm text-letter-2 dark:text-letter-4 leading-6'>
                     $2,000
                  </span>
                  <span className='font-normal text-xs text-letter-4 dark:text-letter-3 leading-6'>
                     Raised of $2,500
                  </span>
               </div>
               <div className='flex flex-col gap-y-[2px]'>
            ...
            <div className='mt-5 flex items-center gap-x-[10px] text-xs text-letter-3 leading-6'>
